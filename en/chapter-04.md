...
![Assessment as the informational governance layer](../images/cap04-assessment-lifecycle.svg)
*Figure 4. Assessment as continuous informational governance: the journey that precedes and accompanies Discovery, Delivery, and Operation*
...
The central output of the prospective dimension is the **Decision Package**: the set of evidence, answered hypotheses, identified risks, and formal recommendation that the trio — Product Owner, Tech Lead, and independent evaluator — will use at the CommitmentGate to decide the capability's fate.
...
ProdOps does not prescribe a single Assessment implementation. What the Framework defines is what Assessment is responsible for producing — qualified Decision Package, Reliability Plan adequate to the risk, evidence-based cycle report, new Business Signals as feedback — and each team's Runtime decides with what frequency, what level of formality, and what instrumentation Assessment operates.
