...
Upstream, Downstream, and the New Operating Model for Digital Products

![Cover](../capa/capa-intent-to-outcome.png)
...
- **Not started** — chapter has not yet been written
- **Draft** — first version written, awaiting review
- **Review N** — in review cycle N (inconsistencies being addressed)
- **Final** — reviewed, no open inconsistencies

---

## Review Cycles

| Cycle | Status | Inconsistencies found | Resolved |
|---|---|---|---|
| 1 — Writing | Completed | 0 | 0 |
| 2 — Review | Completed | 4 | 3 (1 open — origin ambiguity) |
| 3 — Images and Diagrams | Completed | 0 | 0 |
| 4 — Em Dash Removal | Completed | 0 | 0 |
| 5 — Universalization (EXP-NNN removal) | Completed | 0 | 0 |

---

> This is the English translation of the original Portuguese edition.  
