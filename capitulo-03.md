...
graph LR
    ...
    B -->|"Promover"| C["OBC Committed\n(Downstream Declared)"]
    B -->|"outros outcomes"| X["Upstream / Descarte /\nAguardar"]
    C --> D["Readiness Gate"]
    D --> E["Iteration Plan"]
    E --> F["Bootstrap"]
```
