...
O ciclo completo de ponta a ponta — desde o Business Signal até o OBC em estado Released — num único caso rastreável. Partes do ciclo existem no corpus: alguns OBCs estão Released, alguns CommitmentGates foram executados, os Release Trails existem. A composição completa num único caso, com rastreabilidade contínua desde o sinal de negócio original até a evidência de operação em produção, ainda está por documentar.

O CommitmentGate com trio humano completo. Os CommitmentGates documentados no corpus têm o PM como decisor nomeado e a justificativa registrada. A distinção explícita entre o Autor — o condutor do experimento e redator do Decision Package — e o Tech Lead como juiz independente não aparece com identidades distintas em nenhum registro. O mecanismo funciona; a separação explícita dos três papéis (Autor como condutor, PM e Tech Lead como juízes independentes) como três pessoas físicas distintas ainda está por ser documentada.
